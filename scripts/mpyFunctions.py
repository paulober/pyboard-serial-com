...
def get_file_info(file_path):
    ...
    size = stat[6]
    print('{"creation_time": ' + str(creation_time) + ', "modification_time": ' + str(modification_time) + ', "size": ' + str(size) + ', "is_dir": ' + str((stat[0] & 0o170000) == 0o040000) + '}', flush=True)
"""
...
def rename_file(old_name, new_name):
    try:
        ...
        print('{"success": false, "error": "' + str(e) + '"}', flush=True)
"""
